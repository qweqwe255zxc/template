 ...
 * было нельзя: как только контейнер стал 1240, кап начал срабатывать и
 * резал текст до 548px, из-за чего заголовок переносился лишний раз и
 * афиша становилась ВЫШЕ, а не ниже. Ось теперь записана в CSS буквально.
 *
