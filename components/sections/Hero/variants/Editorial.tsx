 ...
 *      предупреждает).
 *
 * Пропорция фотографии меняется брейкпоинтами, а не фиксированной
 * высотой: на 390px горизонтальная полоса 21:9 вырождается в 160px
 * ленты, где не видно ни объекта, ни кадра.
 *
...
export function Editorial(props: HeroSection) {
  ...
  return (
    <Section id={id} surface={surface} spacing="hero" tint="hero">
      ...
      {image ? (
        <div className="relative mt-14 aspect-[4/5] w-full overflow-hidden sm:aspect-[16/9] md:mt-20 lg:aspect-[21/9]">
          <Image
            src={image}
            alt={headline.join(" ")}
            fill
