 ...
 * и кап ширины больше не выводится из контейнера: при 1240 он начинал
 * срабатывать (723px) и оказывался УЖЕ, чем max-w-3xl у самой формы,
 * из-за чего её собственная ширина переставала работать.
 *
