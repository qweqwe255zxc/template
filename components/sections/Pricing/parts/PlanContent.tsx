      ...
      <ul className="mt-7 space-y-2.5 border-t border-rule pt-7">
        {plan.features.map((feature) => {
          ...
          return (
            <li
              key={label}
              // Зачёркнутый пункт НЕ гасится альфой поверх приглушённого
              // цвета. Так было (`text-fg-muted/60`), и это давало 2.53–2.83
              // контраста в светлой теме и 2.20–3.21 в тёмной при норме 4.5
              // — замерено по всем четырнадцати вариантам Pricing. То есть
              // строку, которую написал клиент, было физически трудно
              // прочитать (§1.5 п. 2 CLAUDE.md).
              //
              // «Исключено» и так сказано зачёркиванием, а в вариантах с
              // `checkIcon` — ещё и крестиком вместо галки. Гасить поверх
              // этого цветом значит повторять то же сообщение третий раз,
              // расплачиваясь читаемостью.
              className={cn(
                "flex gap-3 text-small text-fg-muted",
